...
export class DeadlineEntity extends extension.ExtendedCompositeEntity
{
    ...
    public constructor(public readonly deadlinename: string,
    ...
    protected _setup(
        ...
        this._text = new PIXI.Text(this.deadlinename+" à "+this.hour+"h"+this.minutes, {
            fontFamily: "Jura",
            fontSize: 35,
            fill: "black",
        });
        ...
        this._icon = new PIXI.Sprite(
            this._entityConfig.app.loader.resources["images/ui/deadline_ring.png"].texture
        );
        ...
        this._text.position.set(textbg.width/2-this._text.width/2+30, textbg.height/2-this._text.height/2);
    ...
    public _update(frameInfo: entity.FrameInfo) {
        if(this._missed)
        {
            ...
            if(!this._shake)
            {
                ...
                this._activateChildEntity(this._shake, entity.extendConfig({ container: this._icon }));
            }
        }
    }
