...
export class Graphics extends entity.CompositeEntity {
  ...
  public setChoice(nodeOptions: string[], onBoxClick: (choiceId: number) => unknown, subchoice?: () => unknown) {
  ...
  public setFreechoice(nodeOptions: string[], onBoxClick: (choiceId: number) => unknown) {
    this._dialogLayer.visible = false;
